...
def get_university_coords(university_name: str) -> Optional[Tuple[float, float]]:
...
def get_universities_by_type(university_type: Optional[str] = None) -> Dict:
...
def get_public_universities() -> Dict:
    return get_universities_by_type('Public')


def get_private_universities() -> Dict:
    return get_universities_by_type('Private')
